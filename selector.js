...
// const cssVariableSource =
//   //   'div[role="row"].x1n2onr6:where(.__fb-dark-mode, .__fb-light-mode)';
//   `${chatBoxContainer} > div > div > div > div.x9f619.x1n2onr6.x1ja2u2z.x78zum5.xdt5ytf.x1iyjqo2.xs83m0k.x193iq5w:where(.__fb-dark-mode, .__fb-light-mode)`;
